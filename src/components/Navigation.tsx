...
export const Navigation = () => {
  ...
  const navItems = [
    ...
    { to: "/jobs/map", icon: Globe, label: "Job Map" },
    ...
    { to: "/ab-testing", icon: Zap, label: "A/B Testing" },
    ...
    { to: "/interview-responses", icon: Brain, label: "Response Library" },
    ...
    { to: "/offer-comparison", icon: DollarSign, label: "Compare Offers" },
    { to: "/career-simulation", icon: LineChart, label: "Career Simulation" },
    ...
    { to: "/admin/api", icon: Settings, label: "API Dashboard" },
    { to: "/settings/integrations", icon: Network, label: "Integrations" },
  ];
